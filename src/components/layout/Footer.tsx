...
/** Pa'lais design: footer - navy background, white text */
const footerLinks = [
  {
    heading: 'Menu',
    links: [
  ...
  { heading: `Contact ${SITE_NAME}`, content: `${CONTACT.name}. Do you have a question? Send it to us.`, phone: CONTACT.phoneE164, phoneDisplay: CONTACT.phone },
              ...
              {SOCIAL_LINKS.map(({ label, href, icon }) => (
                <li key={icon}>
                  <a
                    ...
                    className="flex items-center justify-center w-10 h-10 rounded-full text-white/90 hover:text-white hover:bg-white/10 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-2"
                    aria-label={label}
                  >
